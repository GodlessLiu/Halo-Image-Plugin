...
async function fetchImage(info) {
  ...
  if (res.status === 200) {
    ...
    formData.append("file", new File([blob], `${filename}.${transformTypeToExtension(blob.type)}`, { type: blob.type }))
